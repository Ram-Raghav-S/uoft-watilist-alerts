...
### Documentation Link
Although there is no official documentation we could find, we got the API call working by investigating the request from the network tab in the console. We plan to use the FAQ page for timetable builder as a guide while building the project.
